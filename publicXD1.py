...
# Admin ID
ADMINS = {1174779637}  # Add more admin IDs if needed
OWNER_ID = 1174779637
# Attack settings
nxtlvl_PATH = "./Rahul"
...
REQUIRED_CHANNELS = [@bgmikabhosada"]  # Add required channels here
...
def handle_attack(message):
    ...
    if not is_user_member(user_id):
        ...
        bot.reply_to(message, 
                   ...
                   f"➡️ [Join Channel 1](https://t.me/bgmikabhosada)\n",  parse_mode="Markdown", disable_web_page_preview=True
                )
        return
    ...
    def run_attack():
        ...
        try:
            ...
            time.sleep(300)
            if user_id in pending_feedback:
                banned_users[user_id] = time.time() + 1200  # Ban for 30 minutes
                del pending_feedback[user_id]
                bot.reply_to(message, f"🚫 You have been banned for 20 minutes for not submitting feedback!")
